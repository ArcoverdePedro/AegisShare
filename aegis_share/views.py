...
from .models import Conversation, CustomUser, IPFSFile
...
def user_list(request):
    ...
    all_users = CustomUser.objects.exclude(id=eu.id).exclude(nivel_permissao="CLI")
