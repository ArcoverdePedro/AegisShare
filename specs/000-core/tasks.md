...
- [x] **T-CORE-10** Decidir e executar mudança de licença MIT -> AGPL-3.0 após aprovação do mantenedor. A decisão foi executada em 2026-09-15: `LICENSE` contém a GNU Affero General Public License v3, `pyproject.toml` declara `AGPL-3.0-only` e README/Constituição foram alinhados ao novo licenciamento.
