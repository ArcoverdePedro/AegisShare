...
- RBAC/ABAC e negação Gherkin/E2E: `test_permissions.py`, `test_selectors.py`, `test_acceptance_traceability.py`, `test_denied_access_audit.py`, `specs/003-prescricao-farmacia/features/authorization.feature`, `tests/e2e/prescription_authorization.spec.js`.
