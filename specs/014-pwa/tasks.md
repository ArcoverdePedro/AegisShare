...
- [ ] **T-PWA-12** Executar testes de segurança completos para caches, IndexedDB e push. RNF-PWA-08. Já há cobertura de manifest, fallback, cache deny-by-default, limpeza no logout e IndexedDB cifrado com rejeição de `idempotency_key` duplicada; push permanece desabilitado e precisa de cobertura específica quando T-PWA-09 for implementada.
